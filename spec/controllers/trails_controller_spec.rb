  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Trail" do
        expect {
          post :create, params: {trail: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {trail: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested trail" do
        trail = Trail.create! valid_attributes
        put :update, params: {id: trail.to_param, trail: new_attributes}, session: valid_session
        trail.reload
      ...
      it "redirects to the trail" do
        trail = Trail.create! valid_attributes
        put :update, params: {id: trail.to_param, trail: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        trail = Trail.create! valid_attributes
        put :update, params: {id: trail.to_param, trail: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
